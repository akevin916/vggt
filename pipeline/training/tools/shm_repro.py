...
Usage (from the repo root):
    python -m pipeline.training.tools.shm_repro                          # 30 min, 8 workers, DataLoader-like
    python -m pipeline.training.tools.shm_repro --minutes 60 --workers 12 --strategy file_system

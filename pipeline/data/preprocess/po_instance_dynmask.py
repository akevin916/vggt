#!/usr/bin/env python3
"""Precompute PointOdyssey DYNAMIC MASKS (m*_inst, docs/method.md §3.4) via instance x
...
Run (from the repo root):
  python -m pipeline.data.preprocess.po_instance_dynmask --split test           # small, do first
  python -m pipeline.data.preprocess.po_instance_dynmask --split train          # full (background)
"""

...
Usage:
  python -m pipeline.data.preprocess.gastric_prep --list              # measure + contact sheet only
  python -m pipeline.data.preprocess.gastric_prep --export_top 3      # also write the 3 best segments
  python -m pipeline.data.preprocess.gastric_prep --export 987 1143   # or an explicit frame range
"""
...
from pipeline.eval.paths import output_dir_for_exp

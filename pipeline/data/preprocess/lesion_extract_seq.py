...
folder. Score it with:
    ...
    python -m pipeline.benchmark.eval_lesion --lesion_root ../data/eval/lesion_seq --ckpts ...

Usage:
    python -m pipeline.data.preprocess.lesion_extract_seq --sampling motion --n_frames 64
    python -m pipeline.data.preprocess.lesion_extract_seq --stride 1 --n_frames 80 --out_name dense
...
def main():
    ...
    print(f"\n完成。評分用：\n  python -m pipeline.benchmark.eval_lesion "

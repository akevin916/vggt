...
the case §3.4 (m_geo) targets: derive the label geometrically from GT depth+pose vs. observed
...
Run (from the repo root):
  python -m pipeline.data.preprocess.spring_raft_dynmask                       # all train seqs
  python -m pipeline.data.preprocess.spring_raft_dynmask --seqs 0001 --vis     # one seq + viz
"""

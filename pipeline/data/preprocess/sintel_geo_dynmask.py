...
Run from the repo root:
    python -m pipeline.data.preprocess.sintel_geo_dynmask                 # all sequences
    python -m pipeline.data.preprocess.sintel_geo_dynmask --seqs cave_2   # subset
"""
...
from pipeline.data.motion_mask import (  # noqa: E402
    MASK_CACHE_VERSION,
    compute_ego_flow,
    derive_motion_mask,
...
from pipeline.data.paths import data_path  # noqa: E402
from pipeline.data.sintel_io import (  # noqa: E402

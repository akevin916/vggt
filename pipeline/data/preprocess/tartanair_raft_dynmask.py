...
method.md §3.4 (m_geo) - large camera baseline + depth error inflates the "static"
...
Run (from the repo root):
  python -m pipeline.data.preprocess.tartanair_raft_dynmask                              # all train trajs
  python -m pipeline.data.preprocess.tartanair_raft_dynmask --envs abandonedfactory --vis
"""
...
from pipeline.data.datasets.tartanair import TartanAirDataset

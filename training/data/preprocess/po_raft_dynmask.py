...
Faithful to dyn_vggt_method_v3 §5.3(a) (and identical to the Sintel eval convention):
...
Run (from training/):
  python data/preprocess/po_raft_dynmask.py --split train            # all train seqs
  python data/preprocess/po_raft_dynmask.py --split train --seqs ani --vis   # one seq + viz
"""

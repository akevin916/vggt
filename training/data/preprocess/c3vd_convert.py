...
Usage::
    ...
    python data/preprocess/c3vd_convert.py --raw_dir ../data/train/c3vd_raw --inspect cecum_t1_a
    # 1. prove the pose convention on real numbers before converting 10k frames
    python data/preprocess/c3vd_convert.py --raw_dir ../data/train/c3vd_raw --verify cecum_t1_a
    # 2. look at what each FOV costs
    python data/preprocess/c3vd_convert.py --raw_dir ../data/train/c3vd_raw --fov_sweep cecum_t1_a
    # 3. convert everything
    python data/preprocess/c3vd_convert.py --raw_dir ../data/train/c3vd_raw
"""
...
def main():
    ...
    if args.fov_sweep:
        out = args.sweep_out or osp.join(osp.dirname(osp.dirname(osp.abspath(__file__))),
                                         os.pardir, "outputs", "c3vd_convert", "fov_sweep")

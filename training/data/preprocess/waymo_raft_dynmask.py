...
Run (from training/):
  python data/preprocess/waymo_raft_dynmask.py                              # all segments/cams
  python data/preprocess/waymo_raft_dynmask.py --cameras 1 --vis            # front camera only
"""
import os

os.environ.setdefault("OPENCV_IO_ENABLE_OPENEXR", "1")  # must precede cv2 import (EXR depth)
import os.path as osp, glob, argparse, sys

...
Counterpart to ``eval_utils/paths.py``: that one resolves where results are *written*,
...
_DATA_PKG_DIR = os.path.dirname(os.path.abspath(__file__))  # training/data (this code)
TRAINING_DIR = os.path.dirname(_DATA_PKG_DIR)

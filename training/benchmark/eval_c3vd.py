...
Run (from training/):
  python benchmark/eval_c3vd.py --ckpts logs/c3vd_cam_vanilla/ckpts/best.pt
  python benchmark/eval_c3vd.py --ckpts a.pt b.pt --split val --n_frames 50
"""
...
from benchmark.eval_scared import eval_ckpt, list_sequences
from data.paths import data_path
from eval_utils.paths import default_output_dir, output_dir_for_exp

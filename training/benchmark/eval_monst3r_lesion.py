...
Usage::
    ...
    cd training
    python benchmark/eval_monst3r_lesion.py
    python benchmark/eval_monst3r_lesion.py --folders 病灶3 --niter 200
"""
...
def save_cloud(out_stem, depth_list, intrinsic_list, extrinsic_list,
    ...
    """
    from eval_utils.warp_psnr import unproject_to_world   # same as eval_lesion
